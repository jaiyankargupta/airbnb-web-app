...
def seed_db():
    ...
    listings = [
        ...
        Listing(
            title="Rustic Cascade A-Frame Cabin",
            description="Tucked away in the Cascade Range, this rustic-chic A-frame cabin offers the perfect alpine escape. Surrounded by towering pine trees and mountain air, it features a warm cedar interior, a wood-fired stove, a private cedar hot tub, and a spacious front porch for stargazing. Hike direct from your back door.",
            price_per_night=190.0,
            location="Cascades, Oregon",
            category="Cabins",
            host_id=sarah.id,
            image_url="https://images.unsplash.com/photo-1510798831971-661eb04b3739?auto=format&fit=crop&w=800&q=80",
            gallery_urls="https://images.unsplash.com/photo-1449034446853-66c86144b0ad?auto=format&fit=crop&w=800&q=80,https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?auto=format&fit=crop&w=800&q=80",
            amenities="Wifi,Hot Tub,Wood Stove,Kitchen,Mountain View,Free Parking",
            bedrooms=1,
            bathrooms=1,
            max_guests=2,
            rating=4.92,
        ...
        Listing(
            title="Tropical Oceanfront Beach Villa",
            description="Breathe in the ocean breeze at this spectacular modern beach villa. Directly facing the white sand shores of Miami Beach, this luxury villa features a sun-drenched pool deck, direct beach pathways, fully stocked outdoor kitchen, and spacious open layout with contemporary furnishings.",
            ...
            gallery_urls="https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?auto=format&fit=crop&w=800&q=80,https://images.unsplash.com/photo-1613977257363-707ba9348227?auto=format&fit=crop&w=800&q=80",
            amenities="Wifi,Pool,Beach Access,Kitchen,Air Conditioning,Outdoor Grill,Patio",
            bedrooms=3,
            bathrooms=2.5,
            max_guests=6,
            rating=4.86,
        ...
        Listing(
            title="Jungle Canopy Eco Treehouse",
            description="Perched high in the rainforest canopy, this structural bamboo treehouse lets you sleep amongst exotic birds and wild nature. Features a suspension bridge entry, an open-concept lounge, a wrap-around balcony with hammocks, and solar-powered facilities for a sustainable footprint.",
            price_per_night=220.0,
            location="Montezuma, Costa Rica",
            category="Treehouses",
            host_id=john.id,
            image_url="https://images.unsplash.com/photo-1488462237308-ecaa28b729d7?auto=format&fit=crop&w=800&q=80",
            gallery_urls="https://images.unsplash.com/photo-1510798831971-661eb04b3739?auto=format&fit=crop&w=800&q=80,https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?auto=format&fit=crop&w=800&q=80",
            amenities="Wifi,Canopy View,Kitchen,Solar Power,Hammock,Outdoor Shower",
            bedrooms=2,
            bathrooms=1,
            max_guests=4,
            rating=4.94,
        ...
        Listing(
            title="Industrial Brick Loft in Soho",
            description="Stunning historic loft featuring original exposed brick walls, 14-foot timber-beamed ceilings, and massive iron-framed windows. Curated with premium mid-century modern furniture, custom lighting, a private library library collection, and a gourmet kitchen layout. Steps from premium shops and gallery spots.",
            price_per_night=280.0,
            location="Soho, New York",
            category="Trending",
            host_id=john.id,
            image_url="https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?auto=format&fit=crop&w=800&q=80",
            gallery_urls="https://images.unsplash.com/photo-1540555700478-4be289fbecef?auto=format&fit=crop&w=800&q=80,https://images.unsplash.com/photo-1613977257363-707ba9348227?auto=format&fit=crop&w=800&q=80",
            amenities="Wifi,Kitchen,Air Conditioning,Heating,Washing Machine,Library,Office Space",
            bedrooms=2,
            bathrooms=2,
            max_guests=4,
            rating=4.89,
